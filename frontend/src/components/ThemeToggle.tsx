...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="relative w-9 h-9 flex items-center justify-center rounded-lg hover:bg-muted transition-colors outline-none cursor-pointer">
